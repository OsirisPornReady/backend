...
public interface VideoService extends IService<Video> {
    ...
    public STResDTO getByPage(Integer pi, Integer ps, List<String> sort, String defaultSort, String keyword, String title, String serialNumber, String starsRaw, String tagsRaw, String publishTimeStart, String publishTimeEnd, String addTimeStart, String addTimeEnd, List<String> compoundKeyword, Boolean onClient);
