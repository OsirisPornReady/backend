...
public class ComicServiceImpl extends ServiceImpl<ComicMapper, Comic> implements ComicService {
    ...
    public Comic dto2entity(ComicDTO comicDTO) {
        ...
        BeanUtils.copyProperties(comicDTO, comic, "language", "parody", "character", "group", "artist", "male", "female", "mixed", "other", "postedTime", "previewImageSrcList", "localPreviewImageSrcList", "addTime", "updateTime");
    ...
    public ComicDTO entity2dto(Comic comic) {
        ...
        BeanUtils.copyProperties(comic, comicDTO, "language", "parody", "character", "group", "artist", "male", "female", "mixed", "other", "postedTime", "previewImageSrcList", "localPreviewImageSrcList", "addTime", "updateTime");
