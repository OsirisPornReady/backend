...
public interface ComicService extends IService<Comic> {
    ...
    public STResDTO getByPage(Integer pi, Integer ps, List<String> sort, String defaultSort, String keyword, String title, String titleJap, String languageTags, String parodyTags, String characterTags, String groupTags, String artistTags, String maleTags, String femaleTags, String mixedTags, String otherTags, String postedTimeStart, String postedTimeEnd, String addTimeStart, String addTimeEnd, List<String> compoundKeyword);
